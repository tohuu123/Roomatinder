...
export default function PostPage() {
  ...
  const handleCreatePost = async () => {
    if (!currentUser || !newPost.content.trim()) {
      console.error('[handleCreatePost] Validation failed:', {
        hasCurrentUser: !!currentUser,
        hasContent: !!newPost.content.trim()
      });
      alert('Please fill in the content before posting.');
      return;
    }

    try {
      console.log('[handleCreatePost] Creating post with data:', {
      ...
      if (postId) {
        console.log('[handleCreatePost] Post created successfully:', postId);
        // Reset form
        setNewPost({
          content: "",
          category: "general",
        ...
        console.error('[handleCreatePost] Failed to create post - no postId returned');
